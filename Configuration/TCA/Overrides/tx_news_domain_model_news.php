...
$fields = [
    ...
    'recurring_days' => [
        ...
        'config' => [
            'type' => 'check',
            'items' => [
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.monday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.tuesday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.wednesday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.thursday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.friday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.saturday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.sunday'],
            ],
            'cols' => 7
        ],
    ],
    ...
    'recurring_monthly_weekday' => [
        ...
        'config' => [
            ...
            'renderType' => 'selectSingle',
            'items' => [
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.monday', 'value' => 0],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.tuesday', 'value' => 1],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.wednesday', 'value' => 2],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.thursday', 'value' => 3],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.friday', 'value' => 4],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.saturday', 'value' => 5],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:day.sunday', 'value' => 6],
            ],
            'default' => 0,
        ],
    ],
