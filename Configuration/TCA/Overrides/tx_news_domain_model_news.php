...
$fields = [
    ...
    'recurring_days' => [
        ...
        'config' => [
            'type' => 'check',
            'items' => [
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.monday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.tuesday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.wednesday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.thursday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.friday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.saturday'],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.sunday'],
            ],
            'cols' => 7
        ],
    ],
    ...
    'recurring_monthly_weekday' => [
        ...
        'config' => [
            ...
            'renderType' => 'selectSingle',
            'items' => [
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.monday', 'value' => 0],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.tuesday', 'value' => 1],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.wednesday', 'value' => 2],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.thursday', 'value' => 3],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.friday', 'value' => 4],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.saturday', 'value' => 5],
                ['label' => 'LLL:EXT:eventnews_recurring/Resources/Private/Language/locallang_db.xlf:weekday.sunday', 'value' => 6],
            ],
            'default' => 0,
        ],
    ],
